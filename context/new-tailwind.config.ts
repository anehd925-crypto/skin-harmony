...
/**
 * BeautyLens · Tailwind Configuration v2
 *
 * 변경 요약:
 * - 11단계 brand scale (Forest Olive)
 * - 11단계 ink scale (Warm neutral)
 * - sand 3단계 (웜톤 배경)
 * - beneficial/caution/harmful 성분 전용 시맨틱
 * - 3-family 폰트 시스템
 * - 신규 키프레임 (scan/count-up/tag-in/shimmer)
 */
export default {
  darkMode: ["class"],
  content: [
  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        /* Neutral · Warm Ink — 11 steps (shadcn primary/card 변수와는 별도) */
        ink: {
